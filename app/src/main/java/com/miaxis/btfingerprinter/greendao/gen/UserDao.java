...
public class UserDao extends AbstractDao<User, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Finger10 = new Property(12, byte[].class, "finger10", false, "FINGER10");
    }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.isNull(offset + 12) ? null : cursor.getBlob(offset + 12) // finger10
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setFinger10(cursor.isNull(offset + 12) ? null : cursor.getBlob(offset + 12));
     }
